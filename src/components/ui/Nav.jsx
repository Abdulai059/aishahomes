                ...
                <div className="max-w-7xl mx-auto px-4">
                    <div className="flex justify-between items-center py-2">
                        ...
                        <div className="hidden lg:flex items-center gap-8 text-white">
                            ...
                            <a href="/rooms-suites" className="hover:text-yellow-400 transition-colors flex items-center gap-1">
                        ...
                        <div className="hidden lg:flex items-center gap-8 text-white">
                            <a href="/newsletter" className="hover:text-yellow-400 transition-colors flex items-center gap-1">
