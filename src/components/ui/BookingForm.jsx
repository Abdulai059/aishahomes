...
export default function BookingForm({ guestId }) {
    const [form, setForm] = useState({
        ...
        hasBreakfast: false,
        observations: "",
        numNights: 0, // nights will auto-calculate
    });
    ...
    useEffect(() => {
        setForm((prev) => ({ ...prev, numNights: calculateNights() }));
        ...
        <div className="min-h-screen py-12 px-4">
            <div className="max-w-2xl mx-auto">
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-3xl font-semibold text-gray-900 mb-2">Complete Your <br /> Booking</h1>
                    <p className="text-gray-600 text-base">Choose your dates and preferences</p>
                </div>

                <form onSubmit={handleSubmit} className="bg-white rounded-3xl shadow-sm p-8 md:p-10 border border-gray-100 space-y-6">
                    ...
                    {form.numNights > 0 && (
                        <div className="bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-200 rounded-xl p-4">
                            <div className="flex items-center justify-between">
                                ...
                                <span className="text-2xl font-bold text-green-600">{form.numNights}</span>
                            </div>
                        </div>
                    )}
                    ...
                    <div className="bg-gradient-to-r from-amber-50 to-orange-50 border-2 border-amber-200 rounded-xl p-5">
                        <label className="flex items-start gap-4 cursor-pointer group">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-sm text-gray-600">Start your day with a delicious complimentary breakfast</p>
                            </div>
                        </label>
                    </div>
                ...
                <div className="mt-6 bg-white/80 backdrop-blur rounded-2xl p-4 border border-gray-200 flex items-start gap-3">
