        ...
        <section className="bg-white py-16">
            <div className="max-w-7xl mx-auto px-4">
                <div className="grid md:grid-cols-2 gap-8 md:gap-12">
                    <div className="flex flex-col mb-4 md:mb-0 md: text-start justify-center" data-aos="fade-up">
                    ...
                    <div className="relative grid grid-cols-2 gap-4">
                        <div className="col-span-1 mt-12 md:mt-24 overflow-hidden rounded-3xl transition-transform duration-500 ease-in-out hover:scale-105" data-aos="fade-right">
                            <img
                                src="./Lobby-1.jpg"
                        ...
                        <div className="col-span-1 -mt-4 md:-mt-8 overflow-hidden rounded-3xl transition-transform duration-500 ease-in-out hover:scale-105" data-aos="fade-left">
                            <img
