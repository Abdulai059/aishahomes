...
export default function AboutUs() {
  return (
    <div className="font-sans max-w-7xl mx-auto bg-stone-100 text-stone-900 overflow-x-hidden">
      ...
      text-[clamp(26px,4.5vw,48px)]"
        ...
        text-[clamp(16px,2.5vw,20px)]"
            >
              ...
              perfect place to immerse yourself in local culture and explore the
        ...
        text-xs sm:text-sm md:text-[15px]"
            >
              ...
              corporate bodies available for short and long-term stays. We offer
              the facilities of a hotel at a fraction of the cost, with the
              warmth, privacy, and convenience of a true home. Our knowledgeable
              staff are always on hand to help you plan your adventures and
      ...
      <section className="px-[6vw] py-24 bg-blue-950">
        <FadeIn>
          ...
          <p className="max-w-xl text-sm font-light leading-loose text-stone-100/60">
            We believe in building close relationships with every guest through
            attentive, personal service. Our homes are the ideal choice for
            corporate delegates, relocating families, and visitors seeking a
            pleasant, secure, and cost-efficient stay. Your feedback shapes
            everything we do.
          </p>
        </FadeIn>
      </section>
      ...
      <section className="px-[6vw] py-24 bg-stone-200">
        <FadeIn>
          ...
          <p className="text-sm font-light text-gray-600 tracking-wide mb-10">
            ...
            in industry, commerce and in the hospitality industry. Besides, they
            have local and international torch.
          </p>
