      ...
      <div className="max-w-8xl mx-auto px-4">
        ...
        <div className="relative overflow-hidden">
          ...
          <div className="relative grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
            ...
            >
              <span className="flex flex-col items-center justify-center text-center">
                ...
                <p className="text-gray-700 md:text-base text-sm leading-relaxed">
                  Experience refined dining at Aisha Homes. From sunset
                  cocktails at our rooftop lounge to carefully prepared
                  signature dishes, every detail is crafted for elegance,
                  comfort, and exceptional taste. Enjoy in-room dining anytime
            ...
            <div
              className="overflow-hidden hidden md:block transition-transform duration-500 ease-in-out hover:scale-105"
              data-aos="zoom-in"
              data-aos-duration="1200"
              data-aos-delay="200"
            >
            ...
            <div
              className="overflow-hidden md:pr-10 md:flex transition-transform duration-500 ease-in-out hover:scale-105"
              data-aos="zoom-in"
              data-aos-duration="1200"
              data-aos-delay="300"
            >
