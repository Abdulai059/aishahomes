export default function CtaSection() {
    return (
        <section
            className="relative md:min-h-[450px] min-h-[300px] py-24 bg-cover bg-center"
            style={{
        ...
        >
            ...
            <div className="relative container mx-auto px-6 flex flex-col justify-center items-center text-center text-white h-full space-y-6"
                ...
                <button className="bg-white text-gray-900 px-12 py-4 uppercase rounded text-xs md:text-base font-semibold border border-transparent hover:bg-transparent hover:text-white hover:border-white transition-all duration-300">
