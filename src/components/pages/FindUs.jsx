        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          <div className="space-y-8" data-aos="fade-left">
            ...
            <p className="text-gray-700 leading-relaxed md:text-sm text-sm">
              Aisha Homes is perfectly situated in Northern Ghana and the
              Greater Accra area. We're just about 5 minutes from Aliu Mahama
              Stadium Airport Roundabout and only 2 minutes from Aisha Hospital.
            </p>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p
                    href="mailto:info@arthotelng.com"
...
function Maps() {
  return (
    <div className="relative">
      <div
        className="bg-white rounded-sm  shadow-sm overflow-hidden md:h-125 h-100 md:pb-0 pb-8"
        data-aos="fade-right"
      >
        <iframe
