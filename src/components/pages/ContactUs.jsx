    ...
    <main className="min-h-screen w-full bg-white">
      ...
      >
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-gray-300 md:text-sm text-sm max-w-2xl mx-auto">
            Get in touch with Aisha Homes for bookings, inquiries, or any
            assistance. We’re always happy to hear from you.
          </p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-14">
            <div className="md:col-span-2">
              <div className="text-center flex items-center">
                <h2
                  className="text-2xl md:text-3xl text-blue-900 font-medium tracking-wider"
                  style={{ fontFamily: "Columbia-Serial" }}
                >
                  Office Details
                </h2>
                <div className="ml-5 h-0.5 w-15 bg-linear-to-l from-transparent to-blue-800"></div>{" "}
              </div>
            </div>
              ...
              <ul className="space-y-0 bg-white border border-gray-200 rounded-lg overflow-hidden">
                {Object.keys(offices).map((key) => (
                  <li
                    ...
                    className={`py-4 px-4 border-b last:border-b-0 border-gray-200 cursor-pointer relative pl-10 text-sm transition-all ${
                      activeOffice === key
                  ...
                  >
                    <span
                      className={`absolute left-3 top-1/2 -translate-y-1/2 w-3 h-3 rounded-full bg-blue-900 transition-transform ${
                        activeOffice === key ? "scale-150" : "scale-100"
                      }`}
                    ></span>
                    {offices[key].name}
                  </li>
            ...
            <div className="order-1 md:order-2 bg-gray-50 p-6 md:p-10 border-l-2 border-blue-900 rounded-r-lg">
              ...
              <div className="space-y-3">
                ...
                <div className="flex flex-col sm:grid sm:grid-cols-[80px_1fr] gap-1 sm:gap-0 sm:items-center">
                  ...
                  <a
                    href={`https://${currentOffice.website}`}
                    className="text-blue-900 font-bold text-sm md:text-base hover:underline"
                  >
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  />
                  {errors.fullName && (
                    <span className="text-red-500 text-xs md:text-sm block mt-1">
        ...
        <section className="mb-8">
          ...
          <div className="w-full rounded-lg overflow-hidden shadow-md">
            ...
            <p className="text-xs text-gray-600 mt-4 px-2 pb-2">
              Find your nearest Aisha Homes office address and contact details
              or fill out the enquiry form above.
            </p>
          </div>
        </section>
      </div>
