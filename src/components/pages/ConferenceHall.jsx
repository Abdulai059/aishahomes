    ...
    <section className="px-4 py-12 max-w-7xl mx-auto">
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <h1 className="font-cormorant font-normal italic text-white text-5xl md:text-6xl leading-none">
            Our Conference Hall
          </h1>
        ...
        {packages.map((pkg) => (
          ...
          >
            ...
            <div>
              ...
              <p className="text-xs text-gray-400 mt-1">per person / session</p>
            </div>
