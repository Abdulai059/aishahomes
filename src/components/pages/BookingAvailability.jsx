          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full bg-gray-50 border border-gray-300 text-sm text-gray-900 px-4 py-1.5 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-200 focus:border-transparent"
              />
            </div>
            ...
            <div className="flex items-end">
              <button
                ...
                className="w-full text-white px-6 py-2.5 transition rounded-lg font-medium shadow-md hover:shadow-lg"
              >
                Check Availability
              </button>
            </div>
