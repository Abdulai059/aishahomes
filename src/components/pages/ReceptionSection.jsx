      ...
      <div className="max-w-350 mx-auto px-4">
        <div className="text-center mb-12 mx-auto">
          ...
          <p
            ...
            data-aos-delay="200"
          >
            State-of-the-art amenities include a dramatic double-story loft
            lounge, spectacular rooftop lounge, Technogym fitness center, media
            corner, and a gracious 24/7 resident services team.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          ...
          >
            ...
            <p className="text-gray-700 md:text-base text-sm leading-relaxed">
              ...
              experience of our impeccably curated art from local artists, you
