  ...
  const rooms = [
    {
      ...
      capacity: "1-2 Adults",
      description:
        "Walk in, drop your bags, and breathe. The comfortable double bed gives you a perfect retreat. The modern bathroom resets your day in minutes. And if you're not ready to unplug, the smart TV and USB outlets keep everything charged and running.",
      amenities: [
    ...
    },
    {
      ...
      lounge: "–",
      bestFor:
        "Perfect for business travelers or couples needing extra comfort",
      capacity: "2 Adults",
      description:
        "Experience elevated luxury in our spacious master room. The extra-length king bed provides ultimate comfort while the expansive layout gives you room to work and relax. Premium amenities and thoughtful design create the perfect environment for extended stays.",
      amenities: [
    ...
    },
    {
      ...
      capacity: "2-4 Adults",
      description:
        "Enjoy apartment-style living with convenient ground-floor access. The separate lounge area provides space for relaxation while the king bedroom offers privacy. Perfect for families or those seeking a home-away-from-home experience with easy accessibility.",
      amenities: [
    ...
    },
    {
      ...
      lounge: "Yes",
      bestFor:
        "Well suited for families who want space, privacy, and great views",
      capacity: "4-6 Adults",
      description:
        "Indulge in spacious elegance with breathtaking views. This expansive apartment features a luxurious king bedroom, generous living area, and panoramic windows. The elevated location ensures tranquility while premium amenities deliver an unforgettable stay for families.",
      amenities: [
    ...
    },
    {
      ...
      lounge: "Yes",
      bestFor:
        "Best choice for large families or group stays seeking full privacy",
      capacity: "6-8 Adults",
      description:
        "Your private sanctuary awaits. This entire home offers complete independence with multiple bedrooms, full kitchen, and spacious living areas. Perfect for extended stays, family gatherings, or groups seeking the ultimate in privacy and comfort with all the amenities of home.",
      amenities: [
      ...
      >
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <div className="flex items-center justify-center gap-2 mb-6">
            ...
            <span className="text-sm text-yellow-500 font-medium tracking-wider">
              ROOMS
            </span>
          </div>
