  ...
  return (
    <div className="max-w-7xl mx-auto my-16">
      <div className="text-center mb-8 md:mb-12" data-aos="fade-up">
        <h1
          className="text-2xl md:text-4xl px-2 text-gray-900 mb-3 md:mb-4 leading-tight"
      ...
      <div className="text-center mb-8 px-4" data-aos="fade-up">
        <p className="text-gray-600 text-sm md:text-sm max-w-4xl mx-auto leading-relaxed">
          Whichever room or suite you choose, Aish Homes promises the same
          hallmark touches: luxurious rain showers, smart control systems, free
          high-speed WiFi, and 24-hour dining at your service.
        </p>
      </div>
